...
export default function Featured() {
  return (
    <section
      className="flex w-11/12 mx-auto h-[125vh] gap-20 relative overflow-x-hidden my-10"
      data-scroll-section
    >
      <div className="w-[27%] relative h-[60vh] transform translate-y-[35vh]">
        ...
        <Image
          ...
          alt="asset5"
          fill
          className="object-cover  featured-img"
          data-scroll
        />
      </div>
      <div className="w-[48%] relative h-full">
        ...
        <Image
          ...
          alt="asset5"
          fill
          className="object-cover z-0  featured-img"
          data-scroll
        />
      </div>
